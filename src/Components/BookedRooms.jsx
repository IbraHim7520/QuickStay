...
const BookedRooms = ({ room , handleCancelBooking, roomID,bookedRoomDate, handleUpdateBooking  }) => {
    ...
    return (
        <div className="card card-side bg-base-200 shadow-sm">
            ...
            <p className='text-sm font-semibold'>{moment(bookedRoomDate? bookedRoomDate : Date).format('MMM Do YY')}</p>
                <div>
