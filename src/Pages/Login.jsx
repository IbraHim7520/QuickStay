                ...
                <div className="w-full px-6 py-16 rounded-md sm:px-12 md:px-16 xl:col-span-2 dark:bg-gray-50">
                    ...
                    <form noValidate="" action="" className="self-stretch space-y-3">
                        <div>
                            ...
                            <input id="name" type="text" placeholder="example@mail.com" className="w-full input rounded-md " />
                        </div>
                        <div>
                            <label htmlFor="lastname" className="text-sm sr-only">Password*</label>
                            <input id="lastname" type="password" placeholder="*********" className="w-full input rounded-md" />
                            <p className='text-end text-xs link link-hover'>Forget Password?</p>
                        </div>
                        <button type="button" className="w-full btn btn-outline btn-primary">Login</button>
                    </form>
                    <div className='mt-5 space-y-3'>
                        ...
                        <h1 className='text-sm mt-5 text-black'>New Here? Don't Worry <Link to={"/signup"} className='link link-hover'>Register Now</Link></h1>
                    </div>
                </div>
